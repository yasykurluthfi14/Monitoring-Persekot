...
<head>
	...
	<title>PLN - Menu SRM Keuangan</title>
          ...
          <span class="align-middle"><img src="img/icons/Logo_pln_landscape.png" width="100px"></span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="dashboard_SRMKeuangan.php">
              ...
              <i class="align-middle" data-feather="folder"></i> <span class="align-middle">History Persekot</span>
            </a>
					</li>

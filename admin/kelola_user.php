...
?>
            ...
            <main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Kelola</strong> User</h1>
					<a class="badge bg-success" type="button " data-toggle="modal" data-target="#tambah_user"><i data-feather="user-plus"></i> Tambah User</a>
					<br>
					<br>
					<div class="row">
						<div class="card-header">
								...
								<table class="table table-hover my-0" id="example">
                                    ...
                                    include '../config.php';
										$no=1;
										$query = mysqli_query($koneksi,"SELECT * FROM login WHERE role = 'user' ORDER BY id ASC");
												...
												<div class="modal-body">
													...
													<?php 
														if(isset($_POST['Update'])){
															$update=mysqli_query($koneksi,"UPDATE login SET nama='".$_POST['nama']."',username='".$_POST['username']."',email='".$_POST['email']."',role='user' WHERE id='".$_POST['id']."' ");
															if($update){
																echo "<script>alert('Data di Update')</script>";
																echo "<script>location='kelola_user.php'</script>";
															}
														}
													?>
												</div>
											...
											<div class="modal-dialog" role="document">
												...
												<div class="modal-body">
													...
													if(isset($_POST['input'])){
														...
														$dinas = '-';
														$unit = '-';
														$status_persekot = 'Belum Input Dokumen';
														$username = $_POST['username'];
														$password = md5($_POST['password']);
														$email = $_POST['email'];
														$role = 'user';

														$sql = "INSERT INTO login (id, nama, username, email, role, password)
																VALUES ('$id','$nama', '$username','$email','$role','$password')";
			
														$result = mysqli_multi_query($koneksi, $sql);
														if($result===TRUE){
															$sql1 = "INSERT INTO data_persekot (id, nama_lengkap, dinas, unit, status_persekot)
															VALUES ('$id ','$nama', '$dinas','$unit','$status_persekot')";
															$result = mysqli_multi_query($koneksi, $sql1);

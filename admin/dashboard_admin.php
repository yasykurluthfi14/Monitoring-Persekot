<?php 
	...
	$query = mysqli_query($koneksi, "SELECT * FROM data_persekot WHERE status_persekot= 'Menunggu Konfirmasi'  ORDER BY id ASC");
									...
									<div class="col-sm-6">
										...
										<div class="card">
											<div class="card-body">
												...
												<?php
												$query3 = mysqli_query($koneksi, "SELECT SUM(persekot) FROM data_persekot  ORDER BY id ASC");

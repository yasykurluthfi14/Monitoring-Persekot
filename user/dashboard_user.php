								...
								<div class="row">
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Data Persekot</h5>
													</div>
									...
									<div class="col-sm-6">
										<div class="card">
											...
											<?php
												$query2 = mysqli_query($koneksi, "SELECT SUM(persekot) FROM data_persekot  ORDER BY id ASC");
												while($data2 = mysqli_fetch_array($query2) ){ ?>
												<h1 class="mt-1 mb-3">Rp <?php echo number_format($data2['SUM(persekot)'], 0, ',', '.') ; ?></h1>
											<?php } ?>
												<div class="mb-0">
													<span class="text-muted">Pada Tanggal</span>
													 <span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i> <?php echo date('d-m-Y') ?></span>							

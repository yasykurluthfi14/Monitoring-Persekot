          ...
          <span class="align-middle"><img src="img/icons/Logo_pln_landscape.png" width="100px"></span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="dashboard_user.php">
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Persekot</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="input_dokumen.php">
              <i class="align-middle" data-feather="file-plus"></i> <span class="align-middle">Input Dokumen </span>
            </a>
					</li>
